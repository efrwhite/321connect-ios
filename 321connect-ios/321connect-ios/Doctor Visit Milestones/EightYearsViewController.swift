//
//  EightYearsViewController.swift
//  321connect-ios
//
...
class EightYearsViewController:  UIViewController, UIPickerViewDelegate, UIPickerViewDataSource  {

    @IBOutlet weak var Q7: UISwitch!
    @IBOutlet weak var Q: UISwitch!
